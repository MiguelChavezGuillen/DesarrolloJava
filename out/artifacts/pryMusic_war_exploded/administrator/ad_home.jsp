...
<%--
    Document   : ad_home
    Created on : 30/07/2017, 06:44:58 PM
    Author     : Fjorsvartnir
--%>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class="active"><a href="#">Administradores <span class="sr-only">(current)</span></a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="row placeholders">
              ...
              <form action="<s:url action="createAdministrator"/>" method="post">
                    <div class="col-lg-4">
...
<td>
    <div class=""></div>
    <form action="<s:url action="editAdministrator"/>">
                          <input name="id" type="hidden" value="<s:property value="id"/>">
                                 <button class="btn btn-primary">Editar</button>
                      </form>
    
    
    <form action="<s:url action="deleteAdministrator"/>">
        <input name="id" type="hidden" value="<s:property value="id"/>">
